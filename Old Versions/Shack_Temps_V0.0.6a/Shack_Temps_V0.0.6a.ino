...
*/
const char *codeversion = "V0.0.6a";
...
DeviceAddress HF = { 0x28, 0xFF, 0xCC, 0xD3, 0x31, 0x18, 0x02, 0x91 }; 
DeviceAddress IN = { 0x28, 0xFF, 0x36, 0x54, 0xC4, 0x17, 0x05, 0xF6 };
DeviceAddress OUT = { 0x28, 0xFF, 0xE1, 0x44, 0xC4, 0x17, 0x04, 0x9F };
DeviceAddress ATV = { 0x28, 0xFF, 0x3D, 0xEA, 0x31, 0x18, 0x02, 0x21 };
DeviceAddress VHF = { 0x28, 0xFF, 0xCF, 0x53, 0x32, 0x18, 0x01, 0x00 };
